...
export default class MainPage extends Component {
  ...
  /**
     * @param {Object} req
     * @param {Object} res
     * @return {Promise<{upcomingPosts: ([]|*|*[]), activePosts: ([]|*|*[]), getDataError: (boolean|*)}>}
     */
                    ...
                    <>
                      <div className="blog-posts-list-tab-btns">
                        <div className="blog-posts-list-tab-btn-container">
                          <div
                            className={this.state.showActivePosts ?
                                'blog-posts-list-tab-btn active' : 'blog-posts-list-tab-btn'}
                        ...
                        <div className="blog-posts-list-tab-btn-container">
                          <div
                            className={this.state.showUpcomingPosts ?
                                'blog-posts-list-tab-btn active' : 'blog-posts-list-tab-btn'}
