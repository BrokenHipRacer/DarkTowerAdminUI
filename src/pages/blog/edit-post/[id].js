...
export default class EditBlogPost extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      dateInputValue: post && moment.unix(post.dateTimestamp)
          .format('YYYY-MM-DD') + 'T' + moment.unix(post.dateTimestamp)
          .format('HH:mm'),
   ...
   * @param {Object} res
   * @param {Object} query
   * @return {Promise<{post: *, notFoundError: *, getDataError: (boolean|*)}>}
   */
                  ...
                  <div className="edit-blog-post-form-container">
                    ...
                    <div className="edit-blog-post-form-section">
                      ...
                      <div className="edit-blog-post-form-section-input">
                        ...
                        />
                        <span className={this.state.metaDescriptionCharLeft > 0 ?
                            'char-length green' : 'char-length red'}>
