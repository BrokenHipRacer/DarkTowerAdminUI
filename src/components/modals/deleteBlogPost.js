...
/**
 * Delete Blog Post Modal component
 */
  ...
  render() {
    return (
      <div className={this.props.show ?
          'delete-blog-post-modal-wrapper show-delete-blog-post-modal': 'delete-blog-post-modal-wrapper'}>
        <div className="delete-blog-post-modal-content">
          <div className="delete-blog-post-modal-close-wrapper">
            <div className="delete-blog-post-modal-close-button">
              <svg onClick={this.props.hideRequest}
                fill="#FFFFFF" width="32" height="32" viewBox="0 0 32 32"
                  ...
                  <div className="delete-blog-post-modal-confirm-btn-container">
                    {
                      this.props.loading ?
                          ...
                          <div onClick={this.props.deleteBlogPostRequest}
